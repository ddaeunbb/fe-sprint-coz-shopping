      ...
      <div className="product-list-container">
        <ul className="filter-tab">
          ...
          >
            <img
              alt="전체"
              src={`${publicUrl}/images/total.png`}
              className="Total"
            />
          ...
          >
            <img
              alt="상품"
              src={`${publicUrl}/images/product.png`}
              className="Product"
            />
            <span className={`${select === "Product" && "selected"}`}>
              상품
            </span>
          </li>
          <li
          ...
          >
            <img
              alt="카테고리"
              src={`${publicUrl}/images/category.png`}
              className="Category"
            />
            <span className={`${select === "Category" && "selected"}`}>
              카테고리
            </span>
          </li>
          <li
          ...
          >
            <img
              alt="전시"
              src={`${publicUrl}/images/exhibition.png`}
              className="Exhibition"
            />
            <span className={`${select === "Exhibition" && "selected"}`}>
              전시
            </span>
          </li>
          <li
          ...
          >
            <img
              alt="브랜드"
              src={`${publicUrl}/images/brand.png`}
              className="Brand"
            />
            <span className={`${select === "Brand" && "selected"}`}>
              브랜드
            </span>
          </li>
        </ul>
